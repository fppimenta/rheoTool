...
)
{
    ...
    Info<< "Selecting solidThermoModel: " << typeName << endl;
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        ...
        )   << "Unknown solidThermoModel type " << typeName
            << endl << endl
            << "Valid solidThermoModel types are :" << endl
            << dictionaryConstructorTablePtr_->toc()
            << exit(FatalError);
    }

    return autoPtr<solidThermoModel>(cstrIter()(name, mesh));
}
