  ...
  if (outS_.empty())
   ...
   if (outS1_.empty())
   {
      ...
      // Create name of dir
            ...
            dir = U().time().path()/"Xr_down.txt";
                         
           // Open the file
            outS1_.reset(new OFstream(dir));              
   }
   ...
   if (outS2_.empty())
   {
      ...
      // Create name of dir
            ...
            dir = U().time().path()/"Xl_top.txt";
                         
           // Open the file
            outS2_.reset(new OFstream(dir));              
   }
   ...
   if (outS3_.empty())
   {
      ...
      // Create name of dir
            ...
            dir = U().time().path()/"Xl_down.txt";
                         
           // Open the file
            outS3_.reset(new OFstream(dir));              
   }
}
