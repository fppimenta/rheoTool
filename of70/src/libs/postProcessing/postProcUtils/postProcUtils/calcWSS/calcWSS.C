...
//****  User-defined function STARTS here *****//
	...
	// Total extra-stress
        ...
        if (isTwoPhaseFlow_) 
        {
          ...
          (
            mesh().lookupObject<immiscibleConstitutiveTwoPhaseMixture>("constitutiveProperties")
          );
          ...
          if (!incPoly_)
	  {
        ...
        else
        {
          ...
          (
            mesh().lookupObject<constitutiveModel>("constitutiveProperties")
          );
          ...
          if (!incPoly_)
	  {
        ...
        forAll(WSSmag_.boundaryField(), patchI)
	 {	          
           vectorField n(mesh().Sf().boundaryField()[patchI]/mesh().magSf().boundaryField()[patchI]);
