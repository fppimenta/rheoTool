...
namespace EigenIterDirSolvers 
{
    ...
    addToRunTimeSelectionTable(EigenIterDirSolver, GMRES, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::EigenIterDirSolvers::GMRES::GMRES
(
    ...
    else
    {
     FatalErrorIn
        (
            ...
            << "Available Eigen preconditioners for GMRES solver are: " << nl
            << " . ILUT" << nl << " . Diagonal "           
            << endl
            << exit(FatalError);
    }
...
void Foam::EigenIterDirSolvers::GMRES::initialize  
(
...
void Foam::EigenIterDirSolvers::GMRES::setup  
(
...
void Foam::EigenIterDirSolvers::GMRES::solve 
(
