...
Foam::autoPtr<Foam::HypreIJPreconditioner> Foam::HypreIJPreconditioner::New
(
...
)
{
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
        FatalErrorIn
        (
            "HypreIJPreconditioner::New(const dictionary& dict)"
        )   << "Unknown HypreIJPreconditioner type " << typeName
            << endl << endl
            << "Valid HypreIJPreconditioner types are :" << endl
