...
namespace Foam
{
 ...
 <
   constitutiveEqs::PTTLog::PTTFunctions,
   3
 >::names[] =
 {
  "linear",
 ...
 const NamedEnum<constitutiveEqs::PTTLog::PTTFunctions, 3> constitutiveEqs::PTTLog::PTTFunctionNames_;
}
...
)
{
    ...
    tau_ = (etaP/(lambda*(1-zeta_))) * symm( (eigVecs_ & eigVals_ & eigVecs_.T()) - Itensor);
